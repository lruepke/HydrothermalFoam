...
# read data
triangles,T=pc.Read_VTK_POLYDATA(datapath,'T',name_fmt=name_fmt,coord2km=False,depthPositive=True)
# plot
ax_field, ax_cb, CSf, cb,vmin,vmax=pc.plotField(None,triangles, T,figwidth=18, w_offset_cm=0)
fig=plt.gcf()
