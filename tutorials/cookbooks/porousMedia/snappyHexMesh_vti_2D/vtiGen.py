...
def usage(argv):
    ...
    print('[Example]: '+C_RED + basename+C_BLUE + ' vti/model2D'+C_DEFAULT)
    print('='*len(head))
def porousMediaGeneration(vti_file,x=250,y=250,por=0.6,blob=3):
    ...
    print('Data is saved as',vti_file+'.vti')
def main(argv):
    argc=len(argv)
    if(argc!=2):
        usage(argv)
