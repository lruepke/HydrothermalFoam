...
Field[2].DistMax = width_right*12;
...
Physical Volume("rechargeZone") = {1,6};
Physical Volume("dischargeZone") = {2,3,4,5};
Physical Surface("frontAndBack") = {1:6, 11, 15, 19, 23, 29, 35};
Physical Surface("wall") = {8, 14, 10, 16, 28, 21, 24, 34, 33, 31, 30, 26};
Physical Surface("bottom") = {12, 18, 22};
Physical Surface("top") = {25, 32, 7};

Color Gray{Surface{1:6, 11, 15, 19, 23, 29, 35};}
Color Purple{Surface{8, 14, 10, 16, 28, 21, 24, 34, 33, 31, 30, 26};}
Color Red{Surface{12, 18, 22};}
Color Blue{Surface{25, 32, 7};}
